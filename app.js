    ...
    const PACKAGES={regular:{name:"Hoàn trả theo tổng cược",icon:"hoan-tra-tong-cuoc",desc:"Nhận hoàn trả dựa trên tổng cược hợp lệ, không phụ thuộc kết quả thắng thua.",cycle:"Hằng ngày"},daily:{name:"Bảo hiểm cược thua theo ngày",icon:"bao-hiem-cuoc-thua",desc:"Nhận hoàn trả theo kết quả thua ròng hợp lệ được tổng kết trong ngày.",cycle:"Hằng ngày"},weekly:{name:"Bảo hiểm cược thua theo tuần",icon:"chu-ky-tuan",desc:"Gộp kết quả thua ròng hợp lệ trong tuần trước khi tính hoàn trả.",cycle:"Hằng tuần"}};
    ...
    function perksHtml(t){
      const chuaVIP=t.level===0,khoa="Mở khoá từ VIP 1";
      ...
      return `<div class="tier-perks"><div class="perks-head">${chuaVIP?"Quyền lợi hạng Thành viên":"Trọn bộ quyền lợi tại "+vipName(t.level)}</div>`+
        ...
        opt("bao-hiem-cuoc-thua","Bảo hiểm cược thua theo ngày",chuaVIP?"—":pct(t.daily),chuaVIP?khoa:`tối đa ${money(t.dCap)} / ngày`,chuaVIP)+
        opt("chu-ky-tuan","Bảo hiểm cược thua theo tuần",chuaVIP?"—":pct(t.weekly),chuaVIP?khoa:`tối đa ${money(t.wCap)} / tuần`,chuaVIP)+
