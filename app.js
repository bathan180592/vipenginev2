    ...
    // Bộ asset chỉ có huy hiệu 3D, không có icon người — dùng SVG inline cho thẻ "chưa đạt VIP".
    const neutralBadge=`<svg class="user-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" aria-hidden="true"><circle cx="12" cy="8.5" r="3.8"/><path d="M4.5 20.5c0-4.1 3.4-6.6 7.5-6.6s7.5 2.5 7.5 6.6"/></svg><span>THÀNH VIÊN</span>`;
